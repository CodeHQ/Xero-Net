...
namespace Xero.Api.Payroll
{
    public class AmericanPayroll : PayrollApi
    {
        ...
        public AmericanPayroll(string baseUri, IAuthenticator auth, IConsumer consumer, IUser user, IJsonObjectMapper readMapper, IXmlObjectMapper writeMapper, IRateLimiter rateLimiter, ITokenStore tokenStore)
